...
void setup(void)
{
    ...
    if (at_send_check_response("+AT: OK", 100, "AT\r\n"))
    {
      ...
      at_send_check_response("+KEY: APPKEY", 1000, "AT+KEY=APPKEY,\"AppSecretKey\"\r\n");
 ...
 *
 * mosquitto_pub -h <region>.thethings.network -p 1883 -d -u <username> -P <MQTT Integration API Key> \
 * -t v3/<App Name>/devices/<Device Name>/down/push \
 ...
 *
 * mosquitto_sub -h <region>.thethings.network -p 1883 -v -d -u <username> -P <MQTT Integration API Key> -t #
 */
